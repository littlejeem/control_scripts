...
Usage: /home/USER/bin/control_scripts/ripping_scripts/BD_ripping.sh BD_ripping.sh -G -e -t ## -n TITLE HERE -q ## -s -c
	...
	-n Manually provide the feature name to lookup online, eg. -n BIG BUCK BUNNY. Useful for those discs that aren't helpfully named. eg. FEATURE_1
